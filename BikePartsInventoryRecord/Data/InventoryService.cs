...
using BikePartsInventoryRecord.Pages;
...
namespace BikePartsInventoryRecord.Data
{
    public static class InventoryService
    {
        ...
        public static List<InventoryItems> Create(Guid userId,string  addedBy, string itemName, int quantity)
        {
            if (quantity <=0)
            {
                throw new Exception("Item having 0 quantity cannot be added");
            ...
            {
                throw new Exception("The Item Name needs to be a string");
            }
            else if (quantity.GetType()!=typeof(int))
            {
                throw new Exception("The Quantity need to be an integer");
            }
            else
            {
